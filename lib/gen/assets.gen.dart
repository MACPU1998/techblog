...
class $AssetsImageGen {
  ...
  /// File path: assets/image/empty_state.png
  AssetGenImage get emptyState =>
      const AssetGenImage('assets/image/empty_state.png');

  /// File path: assets/image/logo.png
  AssetGenImage get logo => const AssetGenImage('assets/image/logo.png');

  /// File path: assets/image/poster_test.png
  AssetGenImage get posterTest =>
      const AssetGenImage('assets/image/poster_test.png');

  /// File path: assets/image/profileAvatar.png
  AssetGenImage get profileAvatar =>
      const AssetGenImage('assets/image/profileAvatar.png');

  /// File path: assets/image/single_place_holder.jpg
  AssetGenImage get singlePlaceHolder =>
      const AssetGenImage('assets/image/single_place_holder.jpg');

  /// File path: assets/image/tcbot.svg
  String get tcbot => 'assets/image/tcbot.svg';
